...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OrderProduct_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OrderProduct_t qt_meta_stringdata_OrderProduct = {
    {
QT_MOC_LITERAL(0, 0, 12), // "OrderProduct"
QT_MOC_LITERAL(1, 13, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "OrderProduct\0on_pushButton_clicked\0"
};
...
void OrderProduct::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OrderProduct *_t = static_cast<OrderProduct *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject OrderProduct::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OrderProduct.data,
      qt_meta_data_OrderProduct,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OrderProduct::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OrderProduct.stringdata0))
